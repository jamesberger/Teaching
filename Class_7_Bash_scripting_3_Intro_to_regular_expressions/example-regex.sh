...
# Note: Much of this is from tldp.org and can be viewed in more detail there.
#
...
# If we want to match on an entire class of characters without having to write
# things out in a great amount of detail, we'll use character classes. Here is
# a list of the valid character classes:
#
# [:alnum:] matches alphabetic or numeric characters. e.g., A-Za-z0-9.
